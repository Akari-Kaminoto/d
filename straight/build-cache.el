...
(fn)" nil nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "dashboard" (quote ("dashboard-")))) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "dashboard-widgets" (quote ("dashboard-")))) (provide (quote dashboard-autoloads)))))

("org-elpa" "melpa" "gnu-elpa" "emacsmirror" "straight" "use-package" "bind-key" "helm" "async" "popup" "cl-lib" "helm-core" "rainbow-delimiters" "neotree" "volatile-highlights" "smooth-scroll" "hlinum" "undohist" "anzu" "shell-pop" "web-mode" "beacon" "seq" "japanese-holidays" "rainbow-mode" "popup-kill-ring" "pos-tip" "popup-switcher" "move-text" "darkroom" "undo-tree" "markdown-mode" "markdown-preview-mode" "websocket" "web-server" "uuidgen" "markdown-preview-eww" "mozc" "flycheck" "dash" "pkg-info" "epl" "ace-isearch" "dired-du")
