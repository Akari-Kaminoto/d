...
(fn &optional ARG)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "rainbow-mode" (quote ("rainbow-")))) (provide (quote rainbow-mode-autoloads)))))

("org-elpa" "melpa" "gnu-elpa" "emacsmirror" "straight" "use-package" "bind-key" "helm" "async" "popup" "cl-lib" "helm-core" "rainbow-delimiters" "neotree" "volatile-highlights" "smooth-scroll" "hlinum" "undohist" "anzu" "shell-pop" "web-mode" "beacon" "seq" "japanese-holidays" "rainbow-mode" "mozc" "flycheck" "dash" "pkg-info" "epl" "ace-isearch" "dired-du")
