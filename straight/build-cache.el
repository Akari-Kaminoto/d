...
(fn)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "dired-du" (quote ("dired-du-")))) (provide (quote dired-du-autoloads))) "markdown-mode" ((markdown-mode markdown-mode-autoloads) (autoload (quote markdown-mode) "markdown-mode" "Major mode for editing Markdown files.
...
(fn &optional ARG)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "markdown-mode" (quote ("gfm-" "markdown" "defun-markdown-")))) (provide (quote markdown-mode-autoloads))) "websocket" ((websocket-autoloads websocket) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "websocket" (quote ("websocket-")))) (provide (quote websocket-autoloads))) "web-server" ((web-server-autoloads web-server-status-codes web-server) (autoload (quote ws-start) "web-server" "Start a server using HANDLERS and return the server object.
...
(fn HANDLERS PORT &optional LOG-BUFFER &rest NETWORK-ARGS)" nil nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "web-server" (quote ("ws-")))) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "web-server-status-codes" (quote ("ws-status-codes")))) (provide (quote web-server-autoloads))) "uuidgen" ((uuidgen-autoloads uuidgen) (autoload (quote insert-uuid-cid) "uuidgen" "Insert UUID string in CID format that is suitable for COM definition.
If UUID is nil will generate UUIDGEN-4 automatically.
You customize `uuidgen-cid-format-string' to change the default format.

(fn UUID)" t nil) (autoload (quote uuidgen) "uuidgen" "Insert UUIDv4 at point. If TIME-BASED is non-nil, insert UUIDv1 instead.

(fn TIME-BASED)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "uuidgen" (quote ("uuidgen-")))) (provide (quote uuidgen-autoloads))) "markdown-preview-mode" ((markdown-preview-mode markdown-preview-mode-autoloads) (autoload (quote markdown-preview-open-browser) "markdown-preview-mode" "Open the `markdown-preview' in the browser.

(fn)" t nil) (autoload (quote markdown-preview-cleanup) "markdown-preview-mode" "Cleanup `markdown-preview' mode.

(fn)" t nil) (autoload (quote markdown-preview-mode) "markdown-preview-mode" "Markdown preview mode.

(fn &optional ARG)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "markdown-preview-mode" (quote ("markdown-preview-")))) (provide (quote markdown-preview-mode-autoloads))) "markdown-preview-eww" ((markdown-preview-eww markdown-preview-eww-autoloads) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "markdown-preview-eww" (quote ("markdown-preview-eww")))) (provide (quote markdown-preview-eww-autoloads))) "page-break-lines" ((page-break-lines-autoloads page-break-lines) (defvar page-break-lines-char 9472 "Character used to render page break lines.") (custom-autoload (quote page-break-lines-char) "page-break-lines" t) (defvar page-break-lines-lighter " PgLn" "Mode-line indicator for `page-break-lines-mode'.") (custom-autoload (quote page-break-lines-lighter) "page-break-lines" t) (defvar page-break-lines-modes (quote (emacs-lisp-mode lisp-mode scheme-mode compilation-mode outline-mode help-mode)) "Modes in which to enable `page-break-lines-mode'.") (custom-autoload (quote page-break-lines-modes) "page-break-lines" t) (defface page-break-lines (quote ((t :inherit font-lock-comment-face :bold nil :italic nil))) "Face used to colorize page break lines.
If using :bold or :italic, please ensure `page-break-lines-char'
is available in that variant of your font, otherwise it may be
displayed as a junk character." :group (quote page-break-lines)) (autoload (quote page-break-lines-mode) "page-break-lines" "Toggle Page Break Lines mode.
...
(fn &optional N)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "easy-kill" (quote ("easy-")))) (provide (quote easy-kill-autoloads))) "clang-format" ((clang-format clang-format-autoloads) (autoload (quote clang-format-region) "clang-format" "Use clang-format to format the code between START and END according to STYLE.
If called interactively uses the region or the current statement if there is no
no active region. If no STYLE is given uses `clang-format-style'. Use
ASSUME-FILE-NAME to locate a style config file, if no ASSUME-FILE-NAME is given
uses the function `buffer-file-name'.

(fn START END &optional STYLE ASSUME-FILE-NAME)" t nil) (autoload (quote clang-format-buffer) "clang-format" "Use clang-format to format the current buffer according to STYLE.
If no STYLE is given uses `clang-format-style'. Use ASSUME-FILE-NAME
to locate a style config file. If no ASSUME-FILE-NAME is given uses
the function `buffer-file-name'.

(fn &optional STYLE ASSUME-FILE-NAME)" t nil) (defalias (quote clang-format) (quote clang-format-region)) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "clang-format" (quote ("clang-format-")))) (provide (quote clang-format-autoloads))) "init-open-recentf" ((init-open-recentf-autoloads init-open-recentf) (autoload (quote init-open-recentf) "init-open-recentf" "Set 'after-init-hook .

(fn)" nil nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "init-open-recentf" (quote ("init-open-recentf-")))) (provide (quote init-open-recentf-autoloads))) "pandoc" ((pandoc-autoloads pandoc) (autoload (quote pandoc-antiword) "pandoc" "Convert `FILE' to DocBook using Antiword.

(fn FILE)" nil nil) (autoload (quote pandoc-convert-file) "pandoc" "Convert `FILE-PATH' as `INPUT-FORMAT' to `OUTPUT-FORMAT'.

(fn FILE-PATH INPUT-FORMAT OUTPUT-FORMAT)" nil nil) (autoload (quote pandoc-convert-stdio) "pandoc" "Convert `BODY' as `INPUT-FORMAT' to `OUTPUT-FORMAT'.

(fn BODY INPUT-FORMAT OUTPUT-FORMAT)" nil nil) (autoload (quote pandoc-open-eww) "pandoc" "Render `FILE' using EWW and Pandoc.

(fn FILE)" t nil) (autoload (quote pandoc-turn-on-advice-eww) "pandoc" "When `eww-open-file' using Pandoc if the file is not HTML.

Remove advice if `ENABLE' equals `-1'.

(fn &optional ENABLE)" nil nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "pandoc" (quote ("pandoc-")))) (provide (quote pandoc-autoloads))) "ht" ((ht ht-autoloads) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "ht" (quote nil))) (provide (quote ht-autoloads))) "emojify" ((emojify-autoloads emojify) (autoload (quote emojify-set-emoji-styles) "emojify" "Set the type of emojis that should be displayed.
